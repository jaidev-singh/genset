...
export default function TechSitePopup({
  ...
  return (
    <div style={isMobile ? {
      ...
      {/* Row 1: Site ID · Phone · ✕ — all flex, close button is the last item */}
      <div style={{ display: "flex", alignItems: "center", gap: 4, marginBottom: 2 }}>
        <span style={{ fontSize: 14, fontWeight: 700, whiteSpace: "nowrap", flex: "1 1 auto", minWidth: 0, overflow: "hidden", textOverflow: "ellipsis" }}>
          {site.site_id}
        </span>
        <span style={{ fontSize: 12, color: "#555", whiteSpace: "nowrap", flex: "0 0 auto" }}>
        ...
        <button
          ...
          style={{
            ...
            justifyContent: "center", fontWeight: 700, padding: 0, marginLeft: 2
          }}
        >✕</button>
      </div>

      {/* Row 2: Customer name — can truncate */}
      ...
      {/* Row 3: Engine model — long, truncates */}
      <div style={{ fontSize: 12, color: "#555", marginBottom: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
        ⚙️ {site.engine_model || "N/A"}{site.kva ? ` · ${site.kva} KVA` : ""}
      </div>

      {/* Row 4: Last PM · Status — both short, flex */}
      <div style={{ display: "flex", alignItems: "center", gap: 4, fontSize: 12, marginBottom: 2 }}>
        <span style={{ flex: "1 1 auto", color: pmDue ? "#e65100" : "#555", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
          🕐 {site.last_service_date || "Never"}{pmDue ? " ⚠️" : ""}
        </span>
        <span style={{ flex: "0 0 auto", fontWeight: 600, whiteSpace: "nowrap", color: site.genset_status === "Inactive" ? "red" : "#2e7d32" }}>
          {site.genset_status}
        </span>
      </div>
